...
func main() {
	...
	url1 := "https://timedragon.chicmic.in/manage-timesheet"
	url2 := "https://timedragon.chicmic.in/users-leave/apply-leave"
	url3 := "https://timedragon.chicmic.in/users-leave/leave-status"
	wg.Add(3)
	go func() {
